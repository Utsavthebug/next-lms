...
const Module = async ({ params }) => {
  ...
  const rawLessons = replaceMongoIdInArray(module?.lessonIds || []).sort((a, b) => a.order - b.order);

  const lessons = serializeData(rawLessons);

  const sanitizedModule = serializeData(module)
